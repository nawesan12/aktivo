...
async function main() {
  ...
  const business = await db.business.upsert({
    ...
    update: {
      primaryColor: "#B8860B",
      accentColor: "#1A1A2E",
      logo: "https://images.unsplash.com/photo-1621605815971-fbc98d665033?w=200&h=200&fit=crop&crop=center",
      coverImage: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=1200&h=600&fit=crop&crop=center",
    },
    create: {
  ...
  const services = await Promise.all([
    ...
    db.service.create({
      data: {
        ...
        duration: 45,
        price: 7500,
        image: "https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=200&h=200&fit=crop&crop=center",
        sortOrder: 1,
      },
    }),
    db.service.create({
    ...
    db.service.create({
      data: {
        ...
        duration: 20,
        price: 3500,
        image: "https://images.unsplash.com/photo-1621607512214-68297480165e?w=200&h=200&fit=crop&crop=center",
        sortOrder: 0,
      },
    }),
    db.service.create({
