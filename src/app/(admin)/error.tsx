...
const log = createLogger("ui:admin");

/**
 * Errors in the platform administration area.
 */
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="glass rounded-2xl p-10 text-center max-w-md w-full">
        <h1 className="text-xl font-heading font-bold mb-2">Error en el panel de administración</h1>
        <p className="text-muted-foreground text-sm mb-6">Intentá nuevamente.</p>
        {error.digest && (
