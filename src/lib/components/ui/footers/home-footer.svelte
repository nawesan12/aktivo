	...
	<div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
		<div class="mx-auto max-w-md">
			<strong class="block text-center text-xl font-bold text-gray-900 sm:text-3xl">
				Te gustaria enterarte de noticias y lanzamientos?
			</strong>
		...
		<div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
			...
			<div class="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
				<div>
					<strong class="font-medium text-gray-900"> Servicios </strong>
				...
				<div>
					<strong class="font-medium text-gray-900"> Nosotros </strong>
				...
				<div>
					<strong class="font-medium text-gray-900"> Soporte </strong>
		...
		<div class="mt-16 border-t border-gray-100 pt-8">
			<p class="text-center text-xs/relaxed text-gray-500">
				© Aktivo 2024. Todos los derechos reservados.

				<br />

				Creado con ❤ por
				<a href="/" class="text-gray-700 underline transition hover:text-gray-700/75">Nawe</a>.
			</p>
		</div>
	</div>
</footer>
